...
function request_allEntreprise() {
  ...
  // request_getOneProduct
  function request_getOneProduct(id) {
    let dataSucces;
    $.ajax({
      type: "GET",
  ...
  // request_deleteProduct
  function request_deleteProduct(id) {
    console.log(id);
    let dataSucces;
    $.ajax({
      type: "POST",
  ...
  return {
    ...
    getOneProduct(id) {
      return request_getOneProduct(id);
    },
    request_deleteProduct(id) {
      return request_deleteProduct(id);
    }
  };
})();
